...
printf "\n"
printf "\e[1;77m\e[45m  Instagram Brute Forcer v2.0 Author: @g0r60n (Github/IG)   \e[0m\n"
printf "\n"
}
...
#checkroot
dependencies
read -p $'\e[1;92mUsername account: \e[0m' __spanos___
